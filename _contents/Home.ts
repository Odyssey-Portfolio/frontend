...
<div className='text-center md:text-left md:leading-[10] ${FONT_POPPINS.className} ${FONTSTYLE_PARAGRAPH1}'>
  As of now, I am a Consultant at Netcompany Vietnam, maintaining React applications based on customers requirements.
...
<div className='text-center md:text-left ${FONT_POPPINS.className} ${FONTSTYLE_PARAGRAPH1} leading-normal'>
...
<div>
    ...
    <div className='${FONT_POPPINS.className}'>
...
export const CONTENT_MOTORCYCLETRIPS = `<div>
    ...
    <div className='${FONT_POPPINS.className}'>
        Long before I engaged in motorcycle trips, I used to take bicycle trips around my hometown. The feeling of taking in fresh sea breeze, or having a wide vision of surrounding scenery, 
        while slowly pedaling, … it’s impeccable. <br/><br/>
        ...
        I have been thinking about taking long trips to different provinces in Vietnam. But, safety issues explains my hesitation. <br/><br/>
...
export const CONTENT_COFFEE = `<div>
    ...
    <div className='${FONT_POPPINS.className}'>
        Ah yes, my so-called “liquid nitrogen of the day” (laughs). Just a trivia, do you know that overclocking masters use liquid nitrogen to boost CPU frequencies to shocking numbers? 
        Well, this applies the same for me, as without coffee, I can say that my daily productivity is wasted. <br/><br/>
        This is also probably my most commonly ordered drink during the university days, when I and my classmates hung out at different coffee shops to speedrun group projects. <br/><br/>
