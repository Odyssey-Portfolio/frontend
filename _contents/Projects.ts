import { ProjectCardProps } from "@/_components/ProjectCard";

export const CONTENT_PROJECTS: ProjectCardProps[] = [
  {
    name: "EWMH – Worker App",
    image: "/projects/ewmh.png",
  ...
  {
    name: "AIStoryteller",
    image: "/projects/philosopher.png",
