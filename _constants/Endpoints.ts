...
export const BLOG_ENDPOINT = `${DEPLOYED_SERVER_URL}/blog`;

/*AUTHENTICATION ENDPOINTS*/
export const LOGIN_ENDPOINT = `${DEPLOYED_SERVER_URL}/user/login`;
export const REGISTER_ENDPOINT = `${DEPLOYED_SERVER_URL}/user/register`;
